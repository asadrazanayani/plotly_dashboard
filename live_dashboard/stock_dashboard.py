...
ticker='AAPL'
price = yf.Ticker(ticker).history(period='id',interval='15m').reset_index()
...
app.layout = html.Div([
    ...
    dcc.Tabs([
        dcc.Tab(label='Candlestick Chart', 
                children=dcc.Graph(id='stock-graph', figure=fig, style={'height' : '1000px'})),
    ...
    dcc.Interval(id='table-interval', interval=1000, n_intervals=0)
])
